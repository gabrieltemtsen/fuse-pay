          ...
          return (
              ...
              <section class="bg-white dark:bg-gradient-to-b from-blue-700/[4.79] via-gray-800 h-full">
                <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
                  <a href="#" class="inline-flex items-center justify-between px-1 py-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full mb-7 dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                    <Chip
                      media={<img
                        ...
                        src="/celo.png" />}
                      class="text-xs bg-black rounded-full text-white px-4 py-1.5 mr-3"></Chip> <span class="text-sm font-medium ml-2">Powered by Celo</span>
                  ...
                  <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">We Help manage your Company`s Finance</h1>
      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="space-y-2 md:space-y-4">
          ...
          <p className="text-gray-500">
            Use our services to inittiate payroll and transactions and loan requests for your Team/ workers.
          </p>
        </div>
        ...
        <ul role="list" className="space-y-2 sm:space-y-4">
          <li className="flex space-x-3">
            ...
            <span className="text-sm sm:text-base text-gray-500">
              <span className="font-bold">Low costs</span> – Covered by Celo 
            </span>
          </li>
